...
export const alphaGroups = [
  ...
  [ "de_tanha" , "de_chasban" ],
  [ "me_koochik_chap" , "me_koochik_dovar", "me_bozorg_chasban", "me_bozorg_tanha" ],
  [ "re_chasban" , "re_tanha" ],
  [ "ye_koochik_chap", "ye_koochik_dovar" , "ye_bozorg_tanha", "ye_bozorg_chasban" ],
  [ "ne_koochik_rast", "ne_koochik_dovar" , "ne_bozorg_tanha", "ne_bozorg_chasban" ],
  [ "sine_chasban_chap", "sine_chasban_dovar" , "sine_bozorg_chasban", "sine_bozorg_tanha" ],
  //[ "faseleh" ] 
]
...
export const darses = [ 
  ...
  //"be_koochik_chap aa_chasban be_koochik_chap aa_chasban faseleh aa_bakola be_bozorg_tanha faseleh de_tanha aa_bikola de_tanha",
]
